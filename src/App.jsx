        ...
        <main>
            <section>
                ...
                <Accordion className={"accordion"}>
                    <AccordionItem title="Item 1" className="accordion-item">
                        <article>
                            <p>This is an item that has a lot of words.</p>
                            <p>Billy answered: "It only gets easier."</p>
                        </article>
                    </AccordionItem>
                    <AccordionItem title="Item 2" className="accordion-item">
                        <article>
                            <p>I'm the one that needs to find out.</p>
                            <p>Bitter sister asked mister.</p>
                        </article>
                    </AccordionItem>
                    <AccordionItem title="Item 3" className="accordion-item">
                        <article>
